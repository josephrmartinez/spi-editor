    ...
    <>
      ...
      >
        ...
        <div
          ...
          onClick={resetWidth}
          className="opacity-0 group-hover/sidebar:opacity-100 transiton cursor-ew-resize absolute h-full w-1 bg-primary/10 right-0 top-0"
        />
      </aside>
      <div
        ref={navbarRef}
        ...
        {!!params.documentId ? (
          ...
          <nav className="bg-transparent px-3 py-2 w-full">
            {isCollapsed && (
              <MenuIcon
                onClick={resetWidth}
                className="h-6 w-6 text-muted-foreground hover:bg-primary-foreground transition"
                role="button"
              />
            )}
          </nav>
